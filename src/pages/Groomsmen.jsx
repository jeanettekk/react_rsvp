...
function Groomsmen() {
  ...
  const party = [
    { initials: 'BM', name: 'JK', role: 'Groomsman', images: [jkImg, jkImg2, jkImg3], text: 'Hi Im Jk, me and rhys met many moons ago as lil bebes at our first job. He was the tall one, i was the short one, were made quite the pair.' },
